...
public class DTone
{
	...
	public DEnvelope pitch;
	public DEnvelope volume;
	public DEnvelope pitchModifier;
	public DEnvelope pitchModifierAmplitude;
	public DEnvelope volumeMultiplier;
	public DEnvelope volumeMultiplierAmplitude;
	public DEnvelope release;
	public DEnvelope attack;
	public int[] oscillatorVolume;
	public int[] oscillatorPitch;
	public int[] oscillatorDelays;
	public int delayTime;
	public int delayDecay;
	public DFilter filter;
	public DEnvelope filterEnvelope;
	public int duration;
	public int offset;
	...
	public int[] synthesize(int var1, int var2) {
		Arrays.fill(Instrument_samples, 0);
		if (var2 < 10) { // L: 54
			...
			if (this.filter.pairs[0] > 0 || this.filter.pairs[1] > 0) { // L: 130
				...
				if (var1 >= var12 + var13) { // L: 135
					...
					int var17;
					while (var14 < var15) {
						var16 = (int)((long)Instrument_samples[var14 + var12] * (long)filter.forwardMultiplier >> 16); // L: 140

						for (var17 = 0; var17 < var12; ++var17) { // L: 141
							var16 += (int)((long)Instrument_samples[var14 + var12 - 1 - var17] * (long)filter.coefficients[0][var17] >> 16);
						}

						for (var17 = 0; var17 < var14; ++var17) { // L: 142
							var16 -= (int)((long)Instrument_samples[var14 - 1 - var17] * (long)filter.coefficients[1][var17] >> 16);
						}
					...
					while (true) {
						...
						int var18;
						while (var14 < var15) {
							var17 = (int)((long)Instrument_samples[var14 + var12] * (long)filter.forwardMultiplier >> 16); // L: 151

							for (var18 = 0; var18 < var12; ++var18) { // L: 152
								var17 += (int)((long)Instrument_samples[var14 + var12 - 1 - var18] * (long)filter.coefficients[0][var18] >> 16);
							}

							for (var18 = 0; var18 < var13; ++var18) { // L: 153
								var17 -= (int)((long)Instrument_samples[var14 - 1 - var18] * (long)filter.coefficients[1][var18] >> 16);
							}
